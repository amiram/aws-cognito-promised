...
export declare type AuthenticateError = CustomChallengeError | MfaRequiredError | MfaSetupError | NewPasswordRequiredError | SelectMfaTypeError | TotpRequiredError;
